...
|------------|---------|---------------------|
| `UFMCB-Features` | Everyday player installer | `title=UFMCB Features v1.0.3` |
| `UFMCB-Toolkit` | Modder installer | `title=UFMCB Toolkit v1.0.3` |

Release zip names stay descriptive for GitHub:

- `UFMCB-Features-v1.0.3.zip` (contains `UFMCB-Features/`) — **live**
- `UFMCB-Toolkit-v1.0.3.zip` (contains `UFMCB-Toolkit/`) — when shipped

To refresh a stick at `/run/media/sammy/PS2`: `./scripts/sync-ufmcb-usb.sh`

### Memory card install size (v1.0.3)
...
Example: Features `v1.0.3` pairs with Toolkit `v1.0.3` (separate zips / folders).
