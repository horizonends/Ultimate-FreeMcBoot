...
ZIP_FEAT="${REPO}/UFMCB-Features-v1.0.3-alpha.3.zip"
ZIP_TOOL="${REPO}/UFMCB-Toolkit-v1.0.3-alpha.3.zip"
...
printf '%s\n' 'title=UFMCB Features v1.0.3-alpha.3' 'boot=ashorizonends_Installer_EXFAT.elf' > "$USB/UFMCB-Features/title.cfg"
printf '%s\n' 'title=UFMCB Toolkit v1.0.3-alpha.3' 'boot=ashorizonends_Installer_EXFAT.elf' > "$USB/UFMCB-Toolkit/title.cfg"
...
rm -f "$USB"/UFMCB-Features-v1.0.3-alpha.2.zip "$USB"/UFMCB-Toolkit-v1.0.3-alpha.2.zip
