...
ZIP_FEAT="${REPO}/UFMCB-Features-v1.0.3-alpha.5.zip"
ZIP_TOOL="${REPO}/UFMCB-Toolkit-v1.0.3-alpha.5.zip"
...
printf '%s\n' 'title=UFMCB Features v1.0.3-alpha.5 (boot recovery)' 'boot=ashorizonends_Installer_EXFAT.elf' > "$USB/UFMCB-Features/title.cfg"
printf '%s\n' 'title=UFMCB Toolkit v1.0.3-alpha.5 (boot recovery)' 'boot=ashorizonends_Installer_EXFAT.elf' > "$USB/UFMCB-Toolkit/title.cfg"
...
rm -f "$USB"/UFMCB-Features-v1.0.3-alpha.{2,3,4}.zip "$USB"/UFMCB-Toolkit-v1.0.3-alpha.{2,3,4}.zip
